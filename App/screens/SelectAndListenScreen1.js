...
const _storeData = async (value) => {
  ...
  var key = 'listen1Screen'
  await AsyncStorage.setItem(key, value);
  console.log('stored listen screen 1')
...
function SelectAndListenScreen1() {
  ...
  var instructions = 'Select the Latin phrase and listen'
  var buttonTitle = 'Quid est?'
  var wordDescription = 'A question that asks what something is.'
  var lessonIntroImage = '../assets/map.png'
  var buttonAudio = '../assets/quidest.mp3'
    ...
    <SafeAreaView style={main.safeAreaContainer}>
      <View style={main.lessonNameArea}>
        <View style={main.lessonTitleBar}>
          ...
          <TouchableOpacity onPress={()=>{
                navigation.navigate("Select and Listen Activity 2")
                }}>
            <Image 
      ...
      <View style={main.lessonNavButtonArea}> 
        <TouchableOpacity style={main.lessonContinueButton}
                onPress={()=>{navigation.navigate("Select and Listen Activity 2")}}>
