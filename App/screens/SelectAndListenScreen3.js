...
const _storeData = async (value) => {
  ...
  var key = 'listen3Screen'
  await AsyncStorage.setItem(key, value);
  console.log('stored listen screen 3')
...
function SelectAndListenScreen3() {
  ...
  var buttonTitle = 'Ecce est imperium Romanum.'
  var wordDescription = '"est" tells us that this is the imperium Romanum.'
  var lessonIntroImage = '../assets/map.png'
  var buttonAudio = '../assets/ecceestERoma.mp3'
